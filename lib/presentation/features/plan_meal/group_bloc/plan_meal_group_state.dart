...
class PlanMealGroupLoadingState extends PlanMealGroupState {
  const PlanMealGroupLoadingState({required dateTime}) : super(dateTime: dateTime);
}
...
class PlanMealGroupHasMeal extends PlanMealGroupState {
  ...
  const PlanMealGroupHasMeal({required this.foodMealEntity, required dateTime}) : super(dateTime: dateTime);
