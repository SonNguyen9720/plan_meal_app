...
class SearchAllergicIngredient extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) {
    return SearchResult(ingredientList: listIngredient, query: query);
  }
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () async {
                        ...
                        await userRepositoryRemote.postAllergicIngredient([ingredientList[index].id.toString()]);
                        const snackBar = SnackBar(
                          content: Text('Allergic ingredient is added'),
                        );
                    ...
                    child: Card(
                      child: Row(
                        children: [
                          ...
                          IconButton(
                              onPressed: () async {
                                await widget.userRepositoryRemote.postAllergicIngredient([ingredientList[index].id.toString()]);
                                const snackBar = SnackBar(
                                  content: Text('Allergic ingredient is added'),
                                );
                                ScaffoldMessenger.of(context).showSnackBar(snackBar);
