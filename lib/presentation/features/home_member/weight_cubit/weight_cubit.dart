...
class WeightMemberCubit extends Cubit<WeightMemberState> {
  final UserRepository userRepository;

  WeightMemberCubit({required this.userRepository}) : super(const WeightInitial());

  Future<void> loadWeight(DateTime startDate, DateTime endDate, String memberId) async {
    ...
    List<Weight> weightList = await userRepository.getListWeightMember(
        formattedStartDate, formattedEndDate, memberId);
